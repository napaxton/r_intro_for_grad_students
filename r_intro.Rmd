...
regions<-subset(aggregates, country=="East Asia & Pacific" |
...
ggplot(wb[wb$region=="Europe & Central Asia",], aes(x=year, y=trade)) +
...
polity <- polity %>%
  filter(!country %in% "Vietnam South")
...
ggplot(df[df$region=="Middle East & North Africa",], aes(x=year)) +
